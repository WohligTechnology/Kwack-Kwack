  ...
  .factory("Chats", function(
    ...
    return {
      ...
      apiCallWithData: function(url, formData, callback, $scope) {
        ...
        $http.post(adminurl + url, formData).then(
          function(data) {
            if (data) {
              if (!formData.noLoader) {
                $ionicLoading.hide();
      ...
      setkwackPollStateChange: function(fromState) {
        if (
          ...
          fromState == "tab.startPollingex" ||
          fromState == "tab.trailerex" ||
          fromState == "tab.exploremore"
        ) {
          var mainTab = {
            fromState: "tab.explore"
          };
          ...
          fromState == "tab.startPollingdis" ||
          fromState == "tab.trailerdis" ||
          fromState == "tab.exploremoredis"
        ) {
          var mainTab = {
            fromState: "tab.discoverNews"
          };
          ...
          fromState == "tab.startPollingkwack" ||
          fromState == "tab.trailerkwack" ||
          fromState == "tab.exploremorekwack"
        ) {
          var mainTab = {
            fromState: "tab.kwackScreen"
          };
          ...
          fromState == "tab.startPollingsocial" ||
          fromState == "tab.trailersocial" ||
          fromState == "tab.exploremoresocial"
        ) {
          var mainTab = {
            fromState: "tab.social"
          };

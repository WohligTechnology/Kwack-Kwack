connector.controller("SignUpCtrl", function(
  $scope,
  Chats,
  $state,
  ionicToast,
            ...
            $http
              .get("https://graph.facebook.com/v2.5/me", {
                params: {
                  ...
                  fields:
                    "id,name,email,gender,location,website,picture,relationship_status",
                  format: "json"
                }
              })
              .then(
                function(result) {
                  ...
                  Chats.apiCallWithData(
                    "User/getUserforSocailLoginFacebook",
                    $scope.socialLoginData,
                    function(data) {
                      if (data.value == true) {
                        $scope.userData = data.data;
                        ...
                        Chats.apiCallWithData(
                          ...
                          function(data) {
                            console.log(
                              "*********************after saving the user in database",
                              data
                            );
                            if (data.value == true) {
                              $scope.userData = data.data;
                ...
                function(error) {
                  alert(
                    "There was a problem getting your profile. Check the logs for details."
                  );
                  console.log(error);
                }
              );
    ...
    window.plugins.googleplus.login(
      {
        ...
        webClientId:
          "908763420783-p0g7ao7tfieqfq58q7ema6grqti33fg2.apps.googleusercontent.com" // optional clientId of your Web application from Credentials settings of your project - On Android, this MUST be included to get an idToken. On iOS, it is not required.
